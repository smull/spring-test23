...
import com.levelup.spring.model.dto.StockPriceMineTypeWrapper;
...
//   }
    ...
    @RequestMapping(value = "/updateType", method = RequestMethod.POST, consumes = "application/json")
    public @ResponseBody String getUpdateType(@RequestBody StockPriceMineTypeWrapper wrapper){
        //StockPriceMine stockPriceMine = priceServiceMine.getStockPriceMine(company);
        for (StockPriceMine o : wrapper) {
            System.out.println(o.getCompanyName());
            System.out.println(o.getPrice());
            System.out.println(o.getVolume());
        }
